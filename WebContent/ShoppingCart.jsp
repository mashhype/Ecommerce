		...
		<div class="panel panel-default">
  		...
  		<div class="panel panel-info">
				<div class="panel-heading">
					<div class="panel-title">
						<div class="row cartHeader">
							...
							<div class="col-sm-5">
							<p id="messageFont"><i>${emptyCartMessage}</i></p>
							</div>
								<div class="col-sm-3 col-sm-offset-9">
									<a href="MenuOrder.jsp" class="btn btn-warning btn-block" id="orderMoreButton"><b>Order More Items?</b></a>
								</div>
			...
			<table class="table table-hover">
				<tr>
					<th>Menu Item</th><th>Name</th><th>Price</th><th>Portion</th><th>Qty</th><th>Item Total</th><th>Remove?</th>
				</tr>
				...
				<tr>
					...
					<td>$<c:out value="${userCart.value[5]}"></c:out></td><!-- this is the item total line -->
		...
		<div class="panel-footer">
			<div class="row text-center">
				<div class="col-sm-9">
					...
					<h4 class="text-right">Subtotal: <strong>$${subTotalFormatted}</strong></h4>
				</div>
				<div class="col-sm-3">
				<form action="CheckoutServlet" method="get">
					<input type="hidden" name="checkout" value="checkout">
					<button type="submit" class="btn btn-success btn-block" id="checkout"><b>Checkout</b></button>
				</form>
				</div>
