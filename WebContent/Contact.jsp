...
<html>
	<head>
		...
		<title>Contact Us | Wonderful Garden></title>
	...
	<div class="container" id="main">
		...
		<div class="container text-center">	
		 	<!-- Contacts -->
				...
				<div class="col-sm-12">
						<div class="well" >	
		            	<h1 class="text-ctr login-title">Contact Us</h1>
							<form role="form" action="ContactServlet" method="post">
								<div class="form-group">
									<div class="row">
										<div class="col-sm-6 col-sm-offset-3">
												<input type="text" class="form-control" name="nameContact" placeholder="Full Name"/>
				         				</div>
		         					</div>
	         					</div><!-- end form group -->
	         					...
	         					<div class="form-group">
									<div class="row">
										<div class="col-sm-6 col-sm-offset-3">
												<input type="email" class="form-control" name="emailContact" placeholder="Email Address"/>
				         				</div>
		         					</div>
	         					</div><!-- end form group -->
	         					<div class="form-group"> 	
		         					<div class="row">
										<div class="col-sm-6 col-sm-offset-3">
												<textarea class="form-control" name="messageContact" rows="8"></textarea>
				         				</div>
		         					</div>
	         					</div><!-- end form group --> 	
